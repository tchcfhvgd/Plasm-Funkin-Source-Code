...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// Characters
		gf = new Character(400, 130, 'ghost-gf');
		gf.x += gf.positionArray[0];
		gf.y += gf.positionArray[1];
		gf.scrollFactor.set(0.95, 0.95);
		boyfriend = new Character(770, 100, 'ghost-bf', true);
		...
		{
			var numScore:FlxSprite = new FlxSprite(46 * daLoop).loadGraphic(Paths.image('num' + i));
		...
		changeModeText.setFormat(Paths.font("blue.ttf"), 32, FlxColor.WHITE, CENTER);
	...
	override public function update(elapsed:Float)
	{
		...
		if(controls.BACK)
		{
			...
			FlxG.sound.playMusic(Paths.music('plasmMenu'), 1, true);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("blue.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
